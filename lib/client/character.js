...
export { default as Context } from "../../client/character/context";
...
//@index('./editor.js', (f, _) => `import * as ${_.pascalCase(f.name)} from '${f.path}'`)
import * as Editor from "./editor";
//@endindex

//@index('./options.js', (f, _) => `import * as ${_.pascalCase(f.name)} from '${f.path}'`)
